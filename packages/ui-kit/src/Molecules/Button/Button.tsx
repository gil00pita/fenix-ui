...
import { Omit, tuple } from '@fenix-ui/utils/lib/type';
...
function insertSpace(child: React.ReactChild, textAlign:string, needInserted: boolean) {
...
function spaceChildren(children: React.ReactNode, textAlign:string, needInserted: boolean) {
  ...
  return React.Children.map(childList, child =>
    insertSpace(child as React.ReactChild, textAlign, needInserted),
  );
}

const ButtonTypes = tuple('default', 'raised', 'ghost', 'dashed', 'link', 'text');
...
const InternalButton: React.ForwardRefRenderFunction<unknown, ButtonProps> = (props, ref) => {
  ...
  const kids =
    children || children === 0
      ? spaceChildren(children, textAlign, isNeedInserted() && autoInsertSpace)
      : null;
